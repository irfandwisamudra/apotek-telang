...
class SupplierController extends Controller
{
    ...
    public function store(SupplierRequest $request)
    {
        ...
        return redirect('/supplier')->with('created', 'Supplier baru telah ditambahkan!');
    }
    ...
    public function update(SupplierRequest $request, Supplier $supplier)
    {
        ...
        // kembali ke halaman supplier sambil membawa session
        return redirect('/supplier')->with('updated', 'Supplier telah diperbarui!');
    }
    ...
    public function delete(Supplier $supplier)
    {
        ...
        return redirect()->to('/supplier')->with('deleted', 'Supplier telah dihapus!');
    }
}
