...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
                ...
                <div class="sidebar-brand-text mx-3 text-capitalize text-md"><strong>Apotek</strong> <span class="font-weight-normal">Telang</span></div>
            </a>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><?php echo $__env->yieldContent('subtitle'); ?></h1>
        </div>
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Apotek Telang 2023</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
</html><?php /**PATH E:\Coding_Irfan\applications\apotek-telang-final\resources\views/templates/app.blade.php ENDPATH**/ ?>